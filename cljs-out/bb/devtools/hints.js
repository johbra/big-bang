...
var map__26654 = top_item;
var map__26654__$1 = (((((!((map__26654 == null))))?(((((map__26654.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__26654.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__26654):map__26654);
var file = cljs.core.get.call(null,map__26654__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__26654__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__26654__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e26653){var _e = e26653;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___26656 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5733__auto___26656)){
var seen_errors_26657 = temp__5733__auto___26656;
if(cljs.core.truth_(seen_errors_26657.has(self))){
} else {
seen_errors_26657.add(self);

var temp__5735__auto___26658 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5735__auto___26658)){
var sense_26659 = temp__5735__auto___26658;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_26659)].join(''));
} else {
}
}
} else {
