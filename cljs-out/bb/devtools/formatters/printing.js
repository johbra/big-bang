...
var len__4736__auto___22017 = arguments.length;
var i__4737__auto___22018 = (0);
while(true){
if((i__4737__auto___22018 < len__4736__auto___22017)){
args__4742__auto__.push((arguments[i__4737__auto___22018]));

var G__22019 = (i__4737__auto___22018 + (1));
i__4737__auto___22018 = G__22019;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq22014){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22015,G__22016,seq22014__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__22020_SHARP_){
return (!((cljs.core.meta.call(null,p1__22020_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.call(null,map__22021__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e22025){var _e__21101__auto__ = e22025;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e22027){var _e__21101__auto__ = e22027;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__22029 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__22030 = devtools.formatters.state.get_current_state.call(null);
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__22030);

try{var map__22031 = opts;
...
var markup_db = cljs.core.get.call(null,map__22031__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__22029);
}});
...
var temp__5733__auto___22036 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5733__auto___22036)){
var managed_print_level_22037 = temp__5733__auto___22036;
var _STAR_print_level_STAR__orig_val__22034_22038 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__22035_22039 = managed_print_level_22037;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__22035_22039);

try{devtools.formatters.state.update_current_state_BANG_.call(null,(function (p1__22033_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__22033_SHARP_,null);
}));

job_fn.call(null);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__22034_22038);
}} else {
job_fn.call(null);
}
