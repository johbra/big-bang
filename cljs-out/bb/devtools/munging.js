...
var o21839 = temp__5733__auto__;
var temp__5733__auto____$1 = (o21839["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o21840 = temp__5733__auto____$1;
return (o21840["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__21094__auto__ = f;
return (o__21094__auto__["toString"]).call(o__21094__auto__);
} else {
return "";
}
}catch (e21841){var _ = e21841;
return "";
}});
...
try{var o__21094__auto___21843 = t;
(o__21094__auto___21843["cljs$lang$ctorPrWriter"]).call(o__21094__auto___21843,t,writer);
}catch (e21842){var __21844 = e21842;
}
...
var char_code = (function (){var o__21094__auto__ = (new String(char$));
return (o__21094__auto__["charCodeAt"]).call(o__21094__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__21094__auto__ = String;
return (o__21094__auto__["fromCharCode"]).call(o__21094__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__21845 = num_code;
switch (G__21845) {
case (1):
return (185);
...
var o__21094__auto__ = String;
return (o__21094__auto__["fromCharCode"]).call(o__21094__auto__,superscript_code);
});
/**
...
}catch (e21847){var _e__21101__auto__ = e21847;
return false;
}})())){
...
var vec__21848 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__21848,(0),null);
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__21853){
var vec__21854 = p__21853;
var ns_detector = cljs.core.nth.call(null,vec__21854,(0),null);
...
var G__21860 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__21861 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__21860;
remaining_tokens = G__21861;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq21851){
var G__21852 = cljs.core.first.call(null,seq21851);
var seq21851__$1 = cljs.core.next.call(null,seq21851);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21852,seq21851__$1);
}));
...
var vec__21865 = cljs.core.split_with.call(null,(function (p1__21864_SHARP_){
return cljs.core.not_EQ_.call(null,p1__21864_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__21865,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__21865,(1),null);
...
var vec__21871 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__21871,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__21871,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__21874 = cljs.core.rest.call(null,remaining_tokens);
var G__21875 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__21874;
name_tokens = G__21875;
continue;
} else {
...
var vec__21878 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__21878,(0),null);
var arity = cljs.core.nth.call(null,vec__21878,(1),null);
var vec__21881 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__21881,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__21881,(1),null);
var vec__21884 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__21884,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__21884,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__21884,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__21884,(3),null);
...
var vec__21890 = result;
var munged_ns = cljs.core.nth.call(null,vec__21890,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__21890,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__21890,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__21890,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__21890,(4),null);
var arity = cljs.core.nth.call(null,vec__21890,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__21894 = temp__5733__auto__;
var munged_name = cljs.core.nth.call(null,vec__21894,(0),null);
var args = cljs.core.nth.call(null,vec__21894,(1),null);
var vec__21897 = devtools.munging.break_and_demunge_name.call(null,munged_name);
...
var G__21900 = (arity + (1));
var G__21901 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__21902){
var vec__21903 = p__21902;
var arity = cljs.core.nth.call(null,vec__21903,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__21903,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__21906_SHARP_){
return cljs.core.get.call(null,arities,p1__21906_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__21907_SHARP_){
return cljs.core.drop.call(null,(2),p1__21907_SHARP_);
}),sorted_infos);
...
args__4742__auto__.push((arguments[i__4737__auto___21915]));
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__21910){
var vec__21911 = p__21910;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__21911,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq21908){
var G__21909 = cljs.core.first.call(null,seq21908);
var seq21908__$1 = cljs.core.next.call(null,seq21908);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21909,seq21908__$1);
}));
...
var map__21919 = options;
var map__21919__$1 = (((((!((map__21919 == null))))?(((((map__21919.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__21919.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__21919):map__21919);
var include_ns_QMARK_ = cljs.core.get.call(null,map__21919__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__21919__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__21919__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__21919__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__21920 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__21920,(0),null);
var fn_name = cljs.core.nth.call(null,vec__21920,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__21920,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__21920,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__21920,(4),null);
var arity = cljs.core.nth.call(null,vec__21920,(5),null);
...
var o__21094__auto__ = f;
return (o__21094__auto__["getBasis"]).call(o__21094__auto__);
});
/**
...
}catch (e21924){var _e__21101__auto__ = e21924;
...
var G__21925 = (obj[cljs.core.first.call(null,path)]);
var G__21926 = cljs.core.rest.call(null,path);
obj = G__21925;
path = G__21926;
continue;
} else {
...
var _STAR_ = (function (accum,p__21927){
var vec__21928 = p__21927;
var bit = cljs.core.nth.call(null,vec__21928,(0),null);
var protocol = cljs.core.nth.call(null,vec__21928,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__21931){
var vec__21932 = p__21931;
var ns = cljs.core.nth.call(null,vec__21932,(0),null);
var name = cljs.core.nth.call(null,vec__21932,(1),null);
var selector = cljs.core.nth.call(null,vec__21932,(2),null);
...
var post_process = (function (p__21936){
var vec__21937 = p__21936;
var munged_name = cljs.core.nth.call(null,vec__21937,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__21937,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__21935_SHARP_){
return (obj[cljs.core.first.call(null,p1__21935_SHARP_)]);
}),sorted_matches);
