...
var G__17040 = o;
goog.object.set(G__17040,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
var G__17044 = o;
goog.object.set(G__17044,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
var args = null;
if (arguments.length > 0) {
var G__17046__i = 0, G__17046__a = new Array(arguments.length -  0);
while (G__17046__i < G__17046__a.length) {G__17046__a[G__17046__i] = arguments[G__17046__i + 0]; ++G__17046__i;}
  args = new cljs.core.IndexedSeq(G__17046__a,0,null);
} 
...
var args = cljs.core.seq(arglist__17047);
...
var G__17048 = props;
var G__17048__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__17048,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__17048);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__17048__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,(function (){var or__4126__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__17049 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__17049,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__17049;
}
})(),id_class);
...
var G__17050 = (cljs.core.count.call(null,argv) - first_child);
switch (G__17050) {
case (0):
...
var vec__17052 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__17052,(0),null);
var id = cljs.core.nth.call(null,vec__17052,(1),null);
var className = cljs.core.nth.call(null,vec__17052,(2),null);
...
var temp__5739__auto___17055 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5739__auto___17055 == null)){
} else {
var key_17056 = temp__5739__auto___17055;
(jsprops.key = key_17056);
}
...
var temp__5739__auto___17057 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5739__auto___17057 == null)){
} else {
var key_17058 = temp__5739__auto___17057;
(jsprops.key = key_17058);
}
...
var temp__5739__auto___17059 = reagent.impl.util.react_key_from_vec.call(null,argv);
if((temp__5739__auto___17059 == null)){
} else {
var key_17060 = temp__5739__auto___17059;
(jsprops.key = key_17060);
}
...
var temp__5739__auto___17061 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5739__auto___17061 == null)){
} else {
var key_17062 = temp__5739__auto___17061;
(jsprops.key = key_17062);
}
...
var temp__5739__auto___17063 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5739__auto___17063 == null)){
} else {
var key_17064 = temp__5739__auto___17063;
...
return cljs.core.into_array.call(null,cljs.core.map.call(null,(function (p1__17065_SHARP_){
return reagent.impl.protocols.as_element.call(null,compiler,p1__17065_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__17066 = reagent.ratom.check_derefs.call(null,(function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx,compiler);
}));
var res = cljs.core.nth.call(null,vec__17066,(0),null);
var derefed = cljs.core.nth.call(null,vec__17066,(1),null);
...
break;
default:
var G__17071 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
var G__17072 = compiler;
v = G__17071;
compiler = G__17072;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template17076 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template17076 = (function (opts,id,fn_to_element,meta17077){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template17076.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_17078,meta17077__$1){
var self__ = this;
var _17078__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template17076(self__.opts,self__.id,self__.fn_to_element,meta17077__$1));
}));

(reagent.impl.template.t_reagent$impl$template17076.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_17078){
var self__ = this;
var _17078__$1 = this;
return self__.meta17077;
}));

(reagent.impl.template.t_reagent$impl$template17076.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template17076.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template17076.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element.call(null,this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template17076.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element.call(null,this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template17076.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"meta17077","meta17077",-1806695761,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template17076.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template17076.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template17076");

(reagent.impl.template.t_reagent$impl$template17076.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write.call(null,writer__4370__auto__,"reagent.impl.template/t_reagent$impl$template17076");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template17076.
 */
reagent.impl.template.__GT_t_reagent$impl$template17076 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template17076(opts__$1,id__$1,fn_to_element__$1,meta17077){
return (new reagent.impl.template.t_reagent$impl$template17076(opts__$1,id__$1,fn_to_element__$1,meta17077));
});

}

return (new reagent.impl.template.t_reagent$impl$template17076(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
