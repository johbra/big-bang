...
var vec__21036 = axis;
var a_x = cljs.core.nth.call(null,vec__21036,(0),null);
var a_y = cljs.core.nth.call(null,vec__21036,(1),null);
var a_z = cljs.core.nth.call(null,vec__21036,(2),null);
var vec__21039 = v;
var x = cljs.core.nth.call(null,vec__21039,(0),null);
var y = cljs.core.nth.call(null,vec__21039,(1),null);
var z = cljs.core.nth.call(null,vec__21039,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__21042,p__21043){
var vec__21044 = p__21042;
var u1 = cljs.core.nth.call(null,vec__21044,(0),null);
var u2 = cljs.core.nth.call(null,vec__21044,(1),null);
var u3 = cljs.core.nth.call(null,vec__21044,(2),null);
var vec__21047 = p__21043;
var v1 = cljs.core.nth.call(null,vec__21047,(0),null);
var v2 = cljs.core.nth.call(null,vec__21047,(1),null);
var v3 = cljs.core.nth.call(null,vec__21047,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__21050_SHARP_){
return (p1__21050_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
var rotate = (function (p1__21051_SHARP_){
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__21051_SHARP_,axis,angle);
});
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301)], null),(function (p1__21052_SHARP_){
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__21052_SHARP_,angle_lr),angle_ud);
}));
}
});
...
var map__21054 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__21054__$1 = cljs.core.__destructure_map.call(null,map__21054);
var up = cljs.core.get.call(null,map__21054__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__21054__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__5802__auto__ = (function (){var pred__21055 = cljs.core._EQ_;
var expr__21056 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__21055.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__21056))){
return straight;
} else {
if(cljs.core.truth_(pred__21055.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__21056))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__21055.call(null,quil.middlewares.navigation_3d.space,expr__21056))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__21055.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__21056))){
return up;
} else {
if(cljs.core.truth_(pred__21055.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__21056))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__21055.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__21056))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),(function (p1__21053_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__21053_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
}));
} else {
return state;
}
...
return cljs.core.update_in.call(null,user_setup.call(null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301)], null),(function (p1__21058_SHARP_){
return cljs.core.merge.call(null,initial_state,p1__21058_SHARP_);
}));
});
/**
...
var map__21059_21069 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__21059_21070__$1 = cljs.core.__destructure_map.call(null,map__21059_21069);
var vec__21060_21071 = cljs.core.get.call(null,map__21059_21070__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_21072 = cljs.core.nth.call(null,vec__21060_21071,(0),null);
var c_y_21073 = cljs.core.nth.call(null,vec__21060_21071,(1),null);
var c_z_21074 = cljs.core.nth.call(null,vec__21060_21071,(2),null);
var vec__21063_21075 = cljs.core.get.call(null,map__21059_21070__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_21076 = cljs.core.nth.call(null,vec__21063_21075,(0),null);
var u_y_21077 = cljs.core.nth.call(null,vec__21063_21075,(1),null);
var u_z_21078 = cljs.core.nth.call(null,vec__21063_21075,(2),null);
var vec__21066_21079 = cljs.core.get.call(null,map__21059_21070__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_21080 = cljs.core.nth.call(null,vec__21066_21079,(0),null);
var p_y_21081 = cljs.core.nth.call(null,vec__21066_21079,(1),null);
var p_z_21082 = cljs.core.nth.call(null,vec__21066_21079,(2),null);
quil.core.camera.call(null,p_x_21080,p_y_21081,p_z_21082,(p_x_21080 + c_x_21072),(p_y_21081 + c_y_21073),(p_z_21082 + c_z_21074),u_x_21076,u_y_21077,u_z_21078);
