...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3((user_setup.cljs$core$IFn$_invoke$arity$0 ? user_setup.cljs$core$IFn$_invoke$arity$0() : user_setup.call(null)),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$navigation_DASH_2d], null),(function (p1__15955_SHARP_){
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([initial_state,p1__15955_SHARP_], 0));
}));
});
/**
...
var nav_2d_15956 = cljs.core.cst$kw$navigation_DASH_2d.cljs$core$IFn$_invoke$arity$1(state);
var zoom_15957 = cljs.core.cst$kw$zoom.cljs$core$IFn$_invoke$arity$1(nav_2d_15956);
var pos_15958 = cljs.core.cst$kw$position.cljs$core$IFn$_invoke$arity$1(nav_2d_15956);
quil.core.scale.cljs$core$IFn$_invoke$arity$1(zoom_15957);

var tr__15859__auto___15959 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(((quil.core.width() / (2)) / zoom_15957) - cljs.core.first(pos_15958)),(((quil.core.height() / (2)) / zoom_15957) - cljs.core.second(pos_15958))], null);
quil.core.push_matrix();

try{quil.core.translate.cljs$core$IFn$_invoke$arity$1(tr__15859__auto___15959);
...
var G__15960 = quil.middlewares.navigation_2d.mouse_dragged(state,event);
var G__15961 = event;
return (user_mouse_dragged.cljs$core$IFn$_invoke$arity$2 ? user_mouse_dragged.cljs$core$IFn$_invoke$arity$2(G__15960,G__15961) : user_mouse_dragged.call(null,G__15960,G__15961));
}),cljs.core.cst$kw$mouse_DASH_wheel,(function (state,event){
var G__15962 = quil.middlewares.navigation_2d.mouse_wheel(state,event);
var G__15963 = event;
return (user_mouse_wheel.cljs$core$IFn$_invoke$arity$2 ? user_mouse_wheel.cljs$core$IFn$_invoke$arity$2(G__15962,G__15963) : user_mouse_wheel.call(null,G__15962,G__15963));
})], 0));
});
