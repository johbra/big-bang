...
var map__23944 = top_item;
var map__23944__$1 = cljs.core.__destructure_map.call(null,map__23944);
...
}catch (e23943){var _e = e23943;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5802__auto___23945 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5802__auto___23945)){
var seen_errors_23946 = temp__5802__auto___23945;
if(cljs.core.truth_(seen_errors_23946.has(self))){
} else {
seen_errors_23946.add(self);

var temp__5804__auto___23947 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5804__auto___23947)){
var sense_23948 = temp__5804__auto___23947;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_23948)].join(''));
} else {
}
}
} else {
