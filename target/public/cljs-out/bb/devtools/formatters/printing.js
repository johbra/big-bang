...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq22780){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22781,G__22782,seq22780__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__22786_SHARP_){
return (!((cljs.core.meta.call(null,p1__22786_SHARP_) == null)));
})))){
...
var map__22787 = opts;
var map__22787__$1 = (((((!((map__22787 == null))))?(((((map__22787.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__22787.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__22787):map__22787);
var markup_db = cljs.core.get.call(null,map__22787__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e22791){var _e__22016__auto__ = e22791;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e22793){var _e__22016__auto__ = e22793;
return false;
}}
})())){
...
var temp__5733__auto___22802 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5733__auto___22802)){
var managed_print_level_22803 = temp__5733__auto___22802;
var _STAR_print_level_STAR__orig_val__22800_22804 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__22801_22805 = managed_print_level_22803;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__22801_22805);

try{devtools.formatters.state.update_current_state_BANG_.call(null,(function (p1__22799_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__22799_SHARP_,null);
}));

job_fn.call(null);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__22800_22804);
}} else {
job_fn.call(null);
}
