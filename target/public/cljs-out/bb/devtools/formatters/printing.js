...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq22860){
...
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22861,G__22862,seq22860__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__22866_SHARP_){
return (!((cljs.core.meta.call(null,p1__22866_SHARP_) == null)));
})))){
...
var map__22867 = opts;
var map__22867__$1 = cljs.core.__destructure_map.call(null,map__22867);
...
}catch (e22868){var _e__17629__auto__ = e22868;
return false;
}})();
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
...
}catch (e22870){var _e__17629__auto__ = e22870;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__22872 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__22873 = devtools.formatters.state.get_current_state.call(null);
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__22873);

try{var map__22874 = opts;
var map__22874__$1 = cljs.core.__destructure_map.call(null,map__22874);
var markup_db = cljs.core.get.call(null,map__22874__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__22872);
}});
...
var temp__5802__auto___22878 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5802__auto___22878)){
var managed_print_level_22879 = temp__5802__auto___22878;
var _STAR_print_level_STAR__orig_val__22876_22880 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__22877_22881 = managed_print_level_22879;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__22877_22881);

try{devtools.formatters.state.update_current_state_BANG_.call(null,(function (p1__22875_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__22875_SHARP_,null);
}));

job_fn.call(null);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__22876_22880);
}} else {
job_fn.call(null);
}
