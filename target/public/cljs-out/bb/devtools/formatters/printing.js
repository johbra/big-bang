...
var len__4736__auto___18899 = arguments.length;
var i__4737__auto___18900 = (0);
while(true){
if((i__4737__auto___18900 < len__4736__auto___18899)){
args__4742__auto__.push((arguments[i__4737__auto___18900]));

var G__18901 = (i__4737__auto___18900 + (1));
i__4737__auto___18900 = G__18901;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq18896){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__18897,G__18898,seq18896__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__18902_SHARP_){
return (!((cljs.core.meta.call(null,p1__18902_SHARP_) == null)));
})))){
...
var map__18903 = opts;
var map__18903__$1 = (((((!((map__18903 == null))))?(((((map__18903.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__18903.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__18903):map__18903);
var markup_db = cljs.core.get.call(null,map__18903__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e18907){var _e__18132__auto__ = e18907;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e18909){var _e__18132__auto__ = e18909;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__18911 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__18912 = devtools.formatters.state.get_current_state.call(null);
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__18912);

try{var map__18913 = opts;
...
var markup_db = cljs.core.get.call(null,map__18913__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__18911);
}});
...
var temp__5733__auto___18918 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5733__auto___18918)){
var managed_print_level_18919 = temp__5733__auto___18918;
var _STAR_print_level_STAR__orig_val__18916_18920 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__18917_18921 = managed_print_level_18919;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__18917_18921);

try{devtools.formatters.state.update_current_state_BANG_.call(null,(function (p1__18915_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__18915_SHARP_,null);
}));

job_fn.call(null);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__18916_18920);
}} else {
job_fn.call(null);
}
