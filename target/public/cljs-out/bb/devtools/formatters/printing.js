...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq20010){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__20011,G__20012,seq20010__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__20016_SHARP_){
return (!((cljs.core.meta.call(null,p1__20016_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.call(null,map__20017__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e20021){var _e__19246__auto__ = e20021;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e20023){var _e__19246__auto__ = e20023;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__20025 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__20026 = devtools.formatters.state.get_current_state.call(null);
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__20026);

try{var map__20027 = opts;
var map__20027__$1 = (((((!((map__20027 == null))))?(((((map__20027.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__20027.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__20027):map__20027);
var markup_db = cljs.core.get.call(null,map__20027__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__20025);
}});
...
var temp__5733__auto___20032 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5733__auto___20032)){
var managed_print_level_20033 = temp__5733__auto___20032;
var _STAR_print_level_STAR__orig_val__20030_20034 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__20031_20035 = managed_print_level_20033;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__20031_20035);

try{devtools.formatters.state.update_current_state_BANG_.call(null,(function (p1__20029_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__20029_SHARP_,null);
}));

job_fn.call(null);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__20030_20034);
}} else {
job_fn.call(null);
}
