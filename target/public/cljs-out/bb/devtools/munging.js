...
var o18767 = temp__5733__auto__;
var temp__5733__auto____$1 = (o18767["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o18768 = temp__5733__auto____$1;
return (o18768["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__18125__auto__ = f;
return (o__18125__auto__["toString"]).call(o__18125__auto__);
} else {
return "";
}
}catch (e18769){var _ = e18769;
return "";
}});
...
try{var o__18125__auto___18771 = t;
(o__18125__auto___18771["cljs$lang$ctorPrWriter"]).call(o__18125__auto___18771,t,writer);
}catch (e18770){var __18772 = e18770;
}
...
var char_code = (function (){var o__18125__auto__ = (new String(char$));
return (o__18125__auto__["charCodeAt"]).call(o__18125__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__18125__auto__ = String;
return (o__18125__auto__["fromCharCode"]).call(o__18125__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__18773 = num_code;
switch (G__18773) {
case (1):
return (185);
...
var o__18125__auto__ = String;
return (o__18125__auto__["fromCharCode"]).call(o__18125__auto__,superscript_code);
});
/**
...
}catch (e18775){var _e__18132__auto__ = e18775;
return false;
}})())){
...
var vec__18776 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__18776,(0),null);
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__18781){
var vec__18782 = p__18781;
var ns_detector = cljs.core.nth.call(null,vec__18782,(0),null);
...
var G__18788 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__18789 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__18788;
remaining_tokens = G__18789;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq18779){
var G__18780 = cljs.core.first.call(null,seq18779);
var seq18779__$1 = cljs.core.next.call(null,seq18779);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__18780,seq18779__$1);
}));
...
var vec__18793 = cljs.core.split_with.call(null,(function (p1__18792_SHARP_){
return cljs.core.not_EQ_.call(null,p1__18792_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__18793,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__18793,(1),null);
...
var vec__18799 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__18799,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__18799,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__18802 = cljs.core.rest.call(null,remaining_tokens);
var G__18803 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__18802;
name_tokens = G__18803;
continue;
} else {
...
var vec__18806 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__18806,(0),null);
var arity = cljs.core.nth.call(null,vec__18806,(1),null);
var vec__18809 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__18809,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__18809,(1),null);
var vec__18812 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__18812,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__18812,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__18812,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__18812,(3),null);
...
var vec__18818 = result;
var munged_ns = cljs.core.nth.call(null,vec__18818,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__18818,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__18818,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__18818,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__18818,(4),null);
var arity = cljs.core.nth.call(null,vec__18818,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__18822 = temp__5733__auto__;
var munged_name = cljs.core.nth.call(null,vec__18822,(0),null);
var args = cljs.core.nth.call(null,vec__18822,(1),null);
var vec__18825 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__18825,(0),null);
var name = cljs.core.nth.call(null,vec__18825,(1),null);
...
var G__18828 = (arity + (1));
var G__18829 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__18830){
var vec__18831 = p__18830;
var arity = cljs.core.nth.call(null,vec__18831,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__18831,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__18834_SHARP_){
return cljs.core.get.call(null,arities,p1__18834_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__18835_SHARP_){
return cljs.core.drop.call(null,(2),p1__18835_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__18838){
var vec__18839 = p__18838;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__18839,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq18836){
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__18847__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__18847__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__18847__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__18847__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__18848 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__18848,(0),null);
var fn_name = cljs.core.nth.call(null,vec__18848,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__18848,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__18848,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__18848,(4),null);
var arity = cljs.core.nth.call(null,vec__18848,(5),null);
...
var o__18125__auto__ = f;
return (o__18125__auto__["getBasis"]).call(o__18125__auto__);
});
/**
...
}catch (e18852){var _e__18132__auto__ = e18852;
...
var G__18853 = (obj[cljs.core.first.call(null,path)]);
var G__18854 = cljs.core.rest.call(null,path);
obj = G__18853;
path = G__18854;
continue;
} else {
...
var _STAR_ = (function (accum,p__18855){
var vec__18856 = p__18855;
var bit = cljs.core.nth.call(null,vec__18856,(0),null);
var protocol = cljs.core.nth.call(null,vec__18856,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__18859){
var vec__18860 = p__18859;
var ns = cljs.core.nth.call(null,vec__18860,(0),null);
var name = cljs.core.nth.call(null,vec__18860,(1),null);
var selector = cljs.core.nth.call(null,vec__18860,(2),null);
...
var post_process = (function (p__18864){
var vec__18865 = p__18864;
var munged_name = cljs.core.nth.call(null,vec__18865,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__18865,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__18863_SHARP_){
return (obj[cljs.core.first.call(null,p1__18863_SHARP_)]);
}),sorted_matches);
