...
var o22736 = temp__5802__auto__;
var temp__5802__auto____$1 = (o22736["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o22737 = temp__5802__auto____$1;
return (o22737["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__17622__auto__ = f;
return (o__17622__auto__["toString"]).call(o__17622__auto__);
} else {
return "";
}
...
try{var o__17622__auto___22740 = t;
(o__17622__auto___22740["cljs$lang$ctorPrWriter"]).call(o__17622__auto___22740,t,writer);
}catch (e22739){var __22741 = e22739;
}
...
var char_code = (function (){var o__17622__auto__ = (new String(char$));
return (o__17622__auto__["charCodeAt"]).call(o__17622__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__17622__auto__ = String;
return (o__17622__auto__["fromCharCode"]).call(o__17622__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__22742 = num_code;
switch (G__22742) {
case (1):
return (185);
...
var o__17622__auto__ = String;
return (o__17622__auto__["fromCharCode"]).call(o__17622__auto__,superscript_code);
});
/**
...
}catch (e22744){var _e__17629__auto__ = e22744;
return false;
}})())){
...
var vec__22745 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__22745,(0),null);
...
args__5732__auto__.push((arguments[i__5727__auto___22755]));
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__22750){
var vec__22751 = p__22750;
var ns_detector = cljs.core.nth.call(null,vec__22751,(0),null);
...
var G__22757 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__22758 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__22757;
remaining_tokens = G__22758;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq22748){
...
var vec__22762 = cljs.core.split_with.call(null,(function (p1__22761_SHARP_){
return cljs.core.not_EQ_.call(null,p1__22761_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__22762,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__22762,(1),null);
...
var vec__22768 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__22768,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__22768,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__22771 = cljs.core.rest.call(null,remaining_tokens);
var G__22772 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__22771;
name_tokens = G__22772;
continue;
} else {
...
var vec__22775 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__22775,(0),null);
var arity = cljs.core.nth.call(null,vec__22775,(1),null);
var vec__22778 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__22778,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__22778,(1),null);
var vec__22781 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__22781,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__22781,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__22781,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__22781,(3),null);
...
var vec__22787 = result;
var munged_ns = cljs.core.nth.call(null,vec__22787,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__22787,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__22787,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__22787,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__22787,(4),null);
var arity = cljs.core.nth.call(null,vec__22787,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__22791 = temp__5802__auto__;
var munged_name = cljs.core.nth.call(null,vec__22791,(0),null);
var args = cljs.core.nth.call(null,vec__22791,(1),null);
var vec__22794 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__22794,(0),null);
var name = cljs.core.nth.call(null,vec__22794,(1),null);
...
var G__22797 = (arity + (1));
var G__22798 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__22799){
var vec__22800 = p__22799;
var arity = cljs.core.nth.call(null,vec__22800,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__22800,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__22803_SHARP_){
return cljs.core.get.call(null,arities,p1__22803_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__22804_SHARP_){
return cljs.core.drop.call(null,(2),p1__22804_SHARP_);
}),sorted_infos);
...
var args__5732__auto__ = [];
var len__5726__auto___22811 = arguments.length;
var i__5727__auto___22812 = (0);
while(true){
if((i__5727__auto___22812 < len__5726__auto___22811)){
args__5732__auto__.push((arguments[i__5727__auto___22812]));

var G__22813 = (i__5727__auto___22812 + (1));
i__5727__auto___22812 = G__22813;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__22807){
var vec__22808 = p__22807;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__22808,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq22805){
...
var map__22816 = options;
var map__22816__$1 = cljs.core.__destructure_map.call(null,map__22816);
var include_ns_QMARK_ = cljs.core.get.call(null,map__22816__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__22816__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__22816__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__22816__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__22817 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__22817,(0),null);
var fn_name = cljs.core.nth.call(null,vec__22817,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__22817,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__22817,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__22817,(4),null);
var arity = cljs.core.nth.call(null,vec__22817,(5),null);
...
var o__17622__auto__ = f;
return (o__17622__auto__["getBasis"]).call(o__17622__auto__);
});
/**
...
}catch (e22820){var _e__17629__auto__ = e22820;
...
var G__22821 = (obj[cljs.core.first.call(null,path)]);
var G__22822 = cljs.core.rest.call(null,path);
obj = G__22821;
path = G__22822;
continue;
} else {
...
var _STAR_ = (function (accum,p__22823){
var vec__22824 = p__22823;
var bit = cljs.core.nth.call(null,vec__22824,(0),null);
var protocol = cljs.core.nth.call(null,vec__22824,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__22827){
var vec__22828 = p__22827;
var ns = cljs.core.nth.call(null,vec__22828,(0),null);
var name = cljs.core.nth.call(null,vec__22828,(1),null);
var selector = cljs.core.nth.call(null,vec__22828,(2),null);
...
var post_process = (function (p__22832){
var vec__22833 = p__22832;
var munged_name = cljs.core.nth.call(null,vec__22833,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__22833,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__22831_SHARP_){
return (obj[cljs.core.first.call(null,p1__22831_SHARP_)]);
}),sorted_matches);
