...
var o22651 = temp__5733__auto__;
var temp__5733__auto____$1 = (o22651["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o22652 = temp__5733__auto____$1;
return (o22652["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__22009__auto__ = f;
return (o__22009__auto__["toString"]).call(o__22009__auto__);
} else {
return "";
}
}catch (e22653){var _ = e22653;
return "";
}});
...
try{var o__22009__auto___22655 = t;
(o__22009__auto___22655["cljs$lang$ctorPrWriter"]).call(o__22009__auto___22655,t,writer);
}catch (e22654){var __22656 = e22654;
}
...
var char_code = (function (){var o__22009__auto__ = (new String(char$));
return (o__22009__auto__["charCodeAt"]).call(o__22009__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__22009__auto__ = String;
return (o__22009__auto__["fromCharCode"]).call(o__22009__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__22657 = num_code;
switch (G__22657) {
case (1):
return (185);
...
var o__22009__auto__ = String;
return (o__22009__auto__["fromCharCode"]).call(o__22009__auto__,superscript_code);
});
/**
...
}catch (e22659){var _e__22016__auto__ = e22659;
return false;
}})())){
...
var vec__22660 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__22660,(0),null);
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__22665){
var vec__22666 = p__22665;
var ns_detector = cljs.core.nth.call(null,vec__22666,(0),null);
...
var G__22672 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__22673 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__22672;
remaining_tokens = G__22673;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq22663){
...
var vec__22677 = cljs.core.split_with.call(null,(function (p1__22676_SHARP_){
return cljs.core.not_EQ_.call(null,p1__22676_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__22677,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__22677,(1),null);
...
var vec__22683 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__22683,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__22683,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__22686 = cljs.core.rest.call(null,remaining_tokens);
var G__22687 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__22686;
name_tokens = G__22687;
continue;
} else {
...
var vec__22690 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__22690,(0),null);
var arity = cljs.core.nth.call(null,vec__22690,(1),null);
var vec__22693 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__22693,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__22693,(1),null);
var vec__22696 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__22696,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__22696,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__22696,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__22696,(3),null);
...
var vec__22702 = result;
var munged_ns = cljs.core.nth.call(null,vec__22702,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__22702,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__22702,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__22702,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__22702,(4),null);
var arity = cljs.core.nth.call(null,vec__22702,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__22706 = temp__5733__auto__;
var munged_name = cljs.core.nth.call(null,vec__22706,(0),null);
var args = cljs.core.nth.call(null,vec__22706,(1),null);
var vec__22709 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__22709,(0),null);
var name = cljs.core.nth.call(null,vec__22709,(1),null);
...
var G__22712 = (arity + (1));
var G__22713 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__22714){
var vec__22715 = p__22714;
var arity = cljs.core.nth.call(null,vec__22715,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__22715,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__22718_SHARP_){
return cljs.core.get.call(null,arities,p1__22718_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__22719_SHARP_){
return cljs.core.drop.call(null,(2),p1__22719_SHARP_);
}),sorted_infos);
...
var args__4742__auto__ = [];
var len__4736__auto___22726 = arguments.length;
var i__4737__auto___22727 = (0);
while(true){
if((i__4737__auto___22727 < len__4736__auto___22726)){
args__4742__auto__.push((arguments[i__4737__auto___22727]));

var G__22728 = (i__4737__auto___22727 + (1));
i__4737__auto___22727 = G__22728;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__22722){
var vec__22723 = p__22722;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__22723,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq22720){
var G__22721 = cljs.core.first.call(null,seq22720);
var seq22720__$1 = cljs.core.next.call(null,seq22720);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22721,seq22720__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__22731__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__22731__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__22731__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__22731__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__22732 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__22732,(0),null);
var fn_name = cljs.core.nth.call(null,vec__22732,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__22732,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__22732,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__22732,(4),null);
var arity = cljs.core.nth.call(null,vec__22732,(5),null);
...
var o__22009__auto__ = f;
return (o__22009__auto__["getBasis"]).call(o__22009__auto__);
});
/**
...
}catch (e22736){var _e__22016__auto__ = e22736;
...
var G__22737 = (obj[cljs.core.first.call(null,path)]);
var G__22738 = cljs.core.rest.call(null,path);
obj = G__22737;
path = G__22738;
continue;
} else {
...
var _STAR_ = (function (accum,p__22739){
var vec__22740 = p__22739;
var bit = cljs.core.nth.call(null,vec__22740,(0),null);
var protocol = cljs.core.nth.call(null,vec__22740,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__22743){
var vec__22744 = p__22743;
var ns = cljs.core.nth.call(null,vec__22744,(0),null);
var name = cljs.core.nth.call(null,vec__22744,(1),null);
var selector = cljs.core.nth.call(null,vec__22744,(2),null);
...
var post_process = (function (p__22748){
var vec__22749 = p__22748;
var munged_name = cljs.core.nth.call(null,vec__22749,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__22749,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__22747_SHARP_){
return (obj[cljs.core.first.call(null,p1__22747_SHARP_)]);
}),sorted_matches);
