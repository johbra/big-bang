...
var G__17473 = o;
goog.object.set(G__17473,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__17474__delegate = function (args){
...
while (G__17475__i < G__17475__a.length) {G__17475__a[G__17475__i] = arguments[G__17475__i + 0]; ++G__17475__i;}
  args = new cljs.core.IndexedSeq(G__17475__a,0,null);
} 
return G__17474__delegate.call(this,args);};
G__17474.cljs$lang$maxFixedArity = 0;
G__17474.cljs$lang$applyTo = (function (arglist__17476){
var args = cljs.core.seq(arglist__17476);
return G__17474__delegate(args);
});
...
var G__17477 = o;
goog.object.set(G__17477,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__17479__i < G__17479__a.length) {G__17479__a[G__17479__i] = arguments[G__17479__i + 0]; ++G__17479__i;}
  args = new cljs.core.IndexedSeq(G__17479__a,0,null);
} 
...
var G__17481 = props;
var G__17481__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__17481,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__17481);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__17481__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,(function (){var or__4126__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__17482 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__17482,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__17482;
}
})(),id_class);
...
var G__17483 = (cljs.core.count.call(null,argv) - first_child);
switch (G__17483) {
case (0):
...
var vec__17485 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__17485,(0),null);
var id = cljs.core.nth.call(null,vec__17485,(1),null);
var className = cljs.core.nth.call(null,vec__17485,(2),null);
...
var temp__5739__auto___17488 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5739__auto___17488 == null)){
} else {
var key_17489 = temp__5739__auto___17488;
(jsprops.key = key_17489);
}
...
var temp__5739__auto___17490 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5739__auto___17490 == null)){
} else {
var key_17491 = temp__5739__auto___17490;
(jsprops.key = key_17491);
}
...
var temp__5739__auto___17492 = reagent.impl.util.react_key_from_vec.call(null,argv);
if((temp__5739__auto___17492 == null)){
} else {
var key_17493 = temp__5739__auto___17492;
(jsprops.key = key_17493);
}
...
var temp__5739__auto___17494 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5739__auto___17494 == null)){
} else {
var key_17495 = temp__5739__auto___17494;
(jsprops.key = key_17495);
}
...
var temp__5739__auto___17496 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5739__auto___17496 == null)){
} else {
var key_17497 = temp__5739__auto___17496;
(jsprops.key = key_17497);
}
...
return cljs.core.into_array.call(null,cljs.core.map.call(null,(function (p1__17498_SHARP_){
return reagent.impl.protocols.as_element.call(null,compiler,p1__17498_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__17499 = reagent.ratom.check_derefs.call(null,(function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx,compiler);
}));
var res = cljs.core.nth.call(null,vec__17499,(0),null);
var derefed = cljs.core.nth.call(null,vec__17499,(1),null);
...
break;
default:
var G__17504 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
var G__17505 = compiler;
v = G__17504;
compiler = G__17505;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template17509 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template17509 = (function (opts,id,fn_to_element,meta17510){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template17509.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_17511,meta17510__$1){
var self__ = this;
var _17511__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template17509(self__.opts,self__.id,self__.fn_to_element,meta17510__$1));
}));

(reagent.impl.template.t_reagent$impl$template17509.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_17511){
var self__ = this;
var _17511__$1 = this;
return self__.meta17510;
}));

(reagent.impl.template.t_reagent$impl$template17509.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template17509.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template17509.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element.call(null,this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template17509.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element.call(null,this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template17509.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"meta17510","meta17510",21619082,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template17509.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template17509.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template17509");

(reagent.impl.template.t_reagent$impl$template17509.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write.call(null,writer__4370__auto__,"reagent.impl.template/t_reagent$impl$template17509");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template17509.
 */
reagent.impl.template.__GT_t_reagent$impl$template17509 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template17509(opts__$1,id__$1,fn_to_element__$1,meta17510){
return (new reagent.impl.template.t_reagent$impl$template17509(opts__$1,id__$1,fn_to_element__$1,meta17510));
});

}

return (new reagent.impl.template.t_reagent$impl$template17509(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
