...
var G__20243 = o;
goog.object.set(G__20243,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
var G__20247 = o;
goog.object.set(G__20247,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
var G__20251 = props;
var G__20251__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__20251,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__20251);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__20251__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,(function (){var or__4126__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__20252 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__20252,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__20252;
}
})(),id_class);
...
var G__20253 = (cljs.core.count.call(null,argv) - first_child);
switch (G__20253) {
case (0):
...
var vec__20255 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__20255,(0),null);
var id = cljs.core.nth.call(null,vec__20255,(1),null);
var className = cljs.core.nth.call(null,vec__20255,(2),null);
...
var temp__5739__auto___20258 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5739__auto___20258 == null)){
} else {
var key_20259 = temp__5739__auto___20258;
(jsprops.key = key_20259);
}
...
var temp__5739__auto___20260 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5739__auto___20260 == null)){
} else {
var key_20261 = temp__5739__auto___20260;
(jsprops.key = key_20261);
}
...
var temp__5739__auto___20262 = reagent.impl.util.react_key_from_vec.call(null,argv);
if((temp__5739__auto___20262 == null)){
} else {
var key_20263 = temp__5739__auto___20262;
(jsprops.key = key_20263);
}
...
var temp__5739__auto___20264 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5739__auto___20264 == null)){
} else {
var key_20265 = temp__5739__auto___20264;
(jsprops.key = key_20265);
}
...
var temp__5739__auto___20266 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5739__auto___20266 == null)){
} else {
var key_20267 = temp__5739__auto___20266;
(jsprops.key = key_20267);
}
...
return cljs.core.into_array.call(null,cljs.core.map.call(null,(function (p1__20268_SHARP_){
return reagent.impl.protocols.as_element.call(null,compiler,p1__20268_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__20269 = reagent.ratom.check_derefs.call(null,(function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx,compiler);
}));
var res = cljs.core.nth.call(null,vec__20269,(0),null);
var derefed = cljs.core.nth.call(null,vec__20269,(1),null);
...
break;
default:
var G__20274 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
var G__20275 = compiler;
v = G__20274;
compiler = G__20275;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template20279 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template20279 = (function (opts,id,fn_to_element,meta20280){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template20279.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_20281,meta20280__$1){
var self__ = this;
var _20281__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template20279(self__.opts,self__.id,self__.fn_to_element,meta20280__$1));
}));

(reagent.impl.template.t_reagent$impl$template20279.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_20281){
var self__ = this;
var _20281__$1 = this;
return self__.meta20280;
}));

(reagent.impl.template.t_reagent$impl$template20279.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template20279.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template20279.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element.call(null,this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template20279.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element.call(null,this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template20279.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"meta20280","meta20280",-175514590,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template20279.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template20279.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template20279");

(reagent.impl.template.t_reagent$impl$template20279.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write.call(null,writer__4370__auto__,"reagent.impl.template/t_reagent$impl$template20279");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template20279.
 */
reagent.impl.template.__GT_t_reagent$impl$template20279 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template20279(opts__$1,id__$1,fn_to_element__$1,meta20280){
return (new reagent.impl.template.t_reagent$impl$template20279(opts__$1,id__$1,fn_to_element__$1,meta20280));
});

}

return (new reagent.impl.template.t_reagent$impl$template20279(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
