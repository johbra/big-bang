...
var G__13486 = o;
goog.object.set(G__13486,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__13490 = o;
goog.object.set(G__13490,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__13492__i < G__13492__a.length) {G__13492__a[G__13492__i] = arguments[G__13492__i + 0]; ++G__13492__i;}
  args = new cljs.core.IndexedSeq(G__13492__a,0,null);
} 
...
var G__13494 = props;
var G__13494__$1 = (((((!((id == null)))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__13494,cljs.core.cst$kw$id,id):G__13494);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__13494__$1,cljs.core.cst$kw$class,reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4126__auto__ = cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__13495 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__13495,cljs.core.cst$kw$class,reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__13495;
}
})(),id_class);
...
var G__13496 = (cljs.core.count(argv) - first_child);
switch (G__13496) {
case (0):
...
break;
case (1):
var G__13497 = component;
var G__13498 = jsprops;
var G__13499 = reagent.impl.protocols.as_element(this$,cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return reagent.impl.template.global$module$react.createElement(G__13497,G__13498,G__13499);
...
var vec__13501 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13501,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13501,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13501,(2),null);
...
var temp__5739__auto___13504 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___13504 == null)){
} else {
var key_13505 = temp__5739__auto___13504;
(jsprops.key = key_13505);
}
...
var temp__5739__auto___13508 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___13508 == null)){
} else {
var key_13509 = temp__5739__auto___13508;
(jsprops.key = key_13509);
}

var G__13506 = reagent.impl.component.functional_render_fn(compiler,tag);
var G__13507 = jsprops;
return reagent.impl.template.global$module$react.createElement(G__13506,G__13507);
});
/**
...
var temp__5739__auto___13510 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5739__auto___13510 == null)){
} else {
var key_13511 = temp__5739__auto___13510;
(jsprops.key = key_13511);
}
...
var temp__5739__auto___13512 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___13512 == null)){
} else {
var key_13513 = temp__5739__auto___13512;
(jsprops.key = key_13513);
}
...
var temp__5739__auto___13514 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___13514 == null)){
} else {
var key_13515 = temp__5739__auto___13514;
(jsprops.key = key_13515);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__13516_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__13516_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__13517 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13517,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13517,(1),null);
...
break;
default:
var G__13522 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__13523 = compiler;
v = G__13522;
compiler = G__13523;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template13527 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template13527 = (function (opts,id,fn_to_element,meta13528){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template13527.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_13529,meta13528__$1){
var self__ = this;
var _13529__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template13527(self__.opts,self__.id,self__.fn_to_element,meta13528__$1));
}));

(reagent.impl.template.t_reagent$impl$template13527.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_13529){
var self__ = this;
var _13529__$1 = this;
return self__.meta13528;
}));

(reagent.impl.template.t_reagent$impl$template13527.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template13527.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template13527.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template13527.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template13527.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$sym$opts,cljs.core.cst$sym$id,cljs.core.cst$sym$fn_DASH_to_DASH_element,cljs.core.cst$sym$meta13528], null);
}));

(reagent.impl.template.t_reagent$impl$template13527.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template13527.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template13527");

(reagent.impl.template.t_reagent$impl$template13527.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write(writer__4370__auto__,"reagent.impl.template/t_reagent$impl$template13527");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template13527.
 */
reagent.impl.template.__GT_t_reagent$impl$template13527 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template13527(opts__$1,id__$1,fn_to_element__$1,meta13528){
return (new reagent.impl.template.t_reagent$impl$template13527(opts__$1,id__$1,fn_to_element__$1,meta13528));
});

}

return (new reagent.impl.template.t_reagent$impl$template13527(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
