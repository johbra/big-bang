...
var temp__5806__auto__ = p.argv;
if((temp__5806__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__992 = p.children;
return reagent.impl.component.global$module$react.Children.toArray(G__992);
})());
} else {
var v = temp__5806__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__993 = c;
var G__993__$1 = (((G__993 == null))?null:G__993.prototype);
if((G__993__$1 == null)){
return null;
} else {
return G__993__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__994 = c;
var G__994__$1 = (((G__994 == null))?null:G__994.prototype);
if((G__994__$1 == null)){
return null;
} else {
return G__994__$1.render;
}
})() == null)))));
});
...
return (function() { 
var G__997__delegate = function (args){
...
var G__997 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__998__i = 0, G__998__a = new Array(arguments.length -  0);
while (G__998__i < G__998__a.length) {G__998__a[G__998__i] = arguments[G__998__i + 0]; ++G__998__i;}
  args = new cljs.core.IndexedSeq(G__998__a,0,null);
} 
return G__997__delegate.call(this,args);};
G__997.cljs$lang$maxFixedArity = 0;
G__997.cljs$lang$applyTo = (function (arglist__999){
var args = cljs.core.seq(arglist__999);
return G__997__delegate(args);
});
G__997.cljs$core$IFn$_invoke$arity$variadic = G__997__delegate;
return G__997;
})()
;})(c,compiler,f,_,res))
:res);
...
var or__5002__auto__ = (function (){var G__1002 = c;
var G__1002__$1 = (((G__1002 == null))?null:G__1002.constructor);
if((G__1002__$1 == null)){
return null;
} else {
return G__1002__$1.displayName;
}
})();
...
var G__1003 = c;
var G__1003__$1 = (((G__1003 == null))?null:G__1003.constructor);
if((G__1003__$1 == null)){
return null;
} else {
return G__1003__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__1004 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__1005 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__1005);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__1004);
}});
...
var G__1006 = key;
var G__1006__$1 = (((G__1006 instanceof cljs.core.Keyword))?G__1006.fqn:null);
switch (G__1006__$1) {
...
var c = this;
var G__1008_1010 = reagent.impl.component.goog$module$goog$object.get.call(null,c,"cljsRatom");
if((G__1008_1010 == null)){
} else {
reagent.ratom.dispose_BANG_(G__1008_1010);
}
...
var renders_1011 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender], null));
var render_fun_1012 = cljs.core.first(cljs.core.vals(renders_1011));
...
if((cljs.core.count(renders_1011) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_1011))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_1012)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_1012], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__1013 = o;
var G__1014_1017 = G__1013;
var G__1015_1018 = cljs.core.name(k);
var G__1016_1019 = v;
reagent.impl.component.goog$module$goog$object.set.call(null,G__1014_1017,G__1015_1018,G__1016_1019);
...
var G__1020_1023 = cmp.prototype;
var G__1021_1024 = reagent.impl.component.global$module$react.Component.prototype;
var G__1022_1025 = methods$;
reagent.impl.component.goog$module$goog$object.extend.call(null,G__1020_1023,G__1021_1024,G__1022_1025);
...
var G__1026 = c;
var G__1027 = reagent.impl.protocols.get_id(compiler);
return reagent.impl.component.goog$module$goog$object.get.call(null,G__1026,G__1027);
});
reagent.impl.component.cache_react_class = (function reagent$impl$component$cache_react_class(compiler,c,constructor$){
var G__1028_1031 = c;
var G__1029_1032 = reagent.impl.protocols.get_id(compiler);
var G__1030_1033 = constructor$;
reagent.impl.component.goog$module$goog$object.set.call(null,G__1028_1031,G__1029_1032,G__1030_1033);
...
return (function() { 
var G__1034__delegate = function (args){
return reagent.impl.protocols.as_element(compiler,cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args));
};
var G__1034 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__1035__i = 0, G__1035__a = new Array(arguments.length -  0);
while (G__1035__i < G__1035__a.length) {G__1035__a[G__1035__i] = arguments[G__1035__i + 0]; ++G__1035__i;}
  args = new cljs.core.IndexedSeq(G__1035__a,0,null);
} 
return G__1034__delegate.call(this,args);};
G__1034.cljs$lang$maxFixedArity = 0;
G__1034.cljs$lang$applyTo = (function (arglist__1036){
var args = cljs.core.seq(arglist__1036);
return G__1034__delegate(args);
});
G__1034.cljs$core$IFn$_invoke$arity$variadic = G__1034__delegate;
return G__1034;
})()
...
var _STAR_current_component_STAR__orig_val__1039 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__1040 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__1040);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__1039);
}});
...
var vec__1041 = reagent.impl.component.global$module$react.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__1041,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__1041,(1),null);
...
var G__1044_1047 = (function reagent$impl$component$functional_render_$_mount(){
return (function reagent$impl$component$functional_render_$_mount_$_unmount(){
var G__1046 = reagent.impl.component.goog$module$goog$object.get.call(null,reagent_state,"cljsRatom");
if((G__1046 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__1046);
}
});
});
var G__1045_1048 = [];
reagent.impl.component.global$module$react.useEffect(G__1044_1047,G__1045_1048);
