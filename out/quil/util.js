...
var or__5002__auto__ = cljs.core.last(cljs.core.sort.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__1256_SHARP_){
return p1__1256_SHARP_.length();
}),cljs.core.keys(m))));
...
return cljs.core.dorun.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__1260){
var vec__1261 = p__1260;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__1261,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__1261,(1),null);
var len = k.length();
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__1264_SHARP_){
return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[p1__1264_SHARP_,cljs.core.symbol.cljs$core$IFn$_invoke$arity$1(["PConstants/",quil.util.prepare_quil_name(p1__1264_SHARP_)].join(''))],null));
}),constants));
});
quil.util.prepare_quil_cljs_constants = (function quil$util$prepare_quil_cljs_constants(constants){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__1265_SHARP_){
return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[p1__1265_SHARP_,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,cljs.core.cst$sym$cljs$core_SLASH_aget,null,(1),null)),(new cljs.core.List(null,cljs.core.cst$sym$js_SLASH_p5$prototype,null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,quil.util.prepare_quil_name(p1__1265_SHARP_),null,(1),null))], 0))))],null));
}),constants));
});
...
var ret__5781__auto___1271 = (function (){
quil.util.generate_quil_constants = (function quil$util$generate_quil_constants(var_args){
var args__5732__auto__ = [];
var len__5726__auto___1272 = arguments.length;
var i__5727__auto___1273 = (0);
while(true){
if((i__5727__auto___1273 < len__5726__auto___1272)){
args__5732__auto__.push((arguments[i__5727__auto___1273]));

var G__1274 = (i__5727__auto___1273 + (1));
i__5727__auto___1273 = G__1274;
continue;
} else {
}
break;
...
return cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,cljs.core.cst$sym$do,null,(1),null)),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__1266_SHARP_){
return quil.util.make_quil_constant_map(target,cljs.core.first(p1__1266_SHARP_),cljs.core.second(p1__1266_SHARP_));
...
/** @this {Function} */
(quil.util.generate_quil_constants.cljs$lang$applyTo = (function (seq1267){
var G__1268 = cljs.core.first(seq1267);
var seq1267__$1 = cljs.core.next(seq1267);
var G__1269 = cljs.core.first(seq1267__$1);
var seq1267__$2 = cljs.core.next(seq1267__$1);
var G__1270 = cljs.core.first(seq1267__$2);
var seq1267__$3 = cljs.core.next(seq1267__$2);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__1268,G__1269,G__1270,seq1267__$3);
}));
