...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3((user_setup.cljs$core$IFn$_invoke$arity$0 ? user_setup.cljs$core$IFn$_invoke$arity$0() : user_setup.call(null)),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$navigation_DASH_2d], null),(function (p1__2285_SHARP_){
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([initial_state,p1__2285_SHARP_], 0));
}));
});
/**
...
var nav_2d_2286 = cljs.core.cst$kw$navigation_DASH_2d.cljs$core$IFn$_invoke$arity$1(state);
var zoom_2287 = cljs.core.cst$kw$zoom.cljs$core$IFn$_invoke$arity$1(nav_2d_2286);
var pos_2288 = cljs.core.cst$kw$position.cljs$core$IFn$_invoke$arity$1(nav_2d_2286);
quil.core.scale.cljs$core$IFn$_invoke$arity$1(zoom_2287);

var tr__2189__auto___2289 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(((quil.core.width() / (2)) / zoom_2287) - cljs.core.first(pos_2288)),(((quil.core.height() / (2)) / zoom_2287) - cljs.core.second(pos_2288))], null);
quil.core.push_matrix();

try{quil.core.translate.cljs$core$IFn$_invoke$arity$1(tr__2189__auto___2289);
...
var G__2290 = quil.middlewares.navigation_2d.mouse_dragged(state,event);
var G__2291 = event;
return (user_mouse_dragged.cljs$core$IFn$_invoke$arity$2 ? user_mouse_dragged.cljs$core$IFn$_invoke$arity$2(G__2290,G__2291) : user_mouse_dragged.call(null,G__2290,G__2291));
}),cljs.core.cst$kw$mouse_DASH_wheel,(function (state,event){
var G__2292 = quil.middlewares.navigation_2d.mouse_wheel(state,event);
var G__2293 = event;
return (user_mouse_wheel.cljs$core$IFn$_invoke$arity$2 ? user_mouse_wheel.cljs$core$IFn$_invoke$arity$2(G__2292,G__2293) : user_mouse_wheel.call(null,G__2292,G__2293));
})], 0));
});
